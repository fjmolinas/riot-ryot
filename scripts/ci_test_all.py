...
def print_results(riot_dir, results_dir, boards):
    failuresummary = os.path.abspath(os.path.join(riot_dir, results_dir,
                                                  'failuresummary.md'))
    with open(failuresummary,"w+") as failuresummary_file:
        for board in boards:
            boards_result_dir = os.path.abspath(
                                    os.path.join(riot_dir, results_dir,
...
def test_boards():
    ...
    print_results(args.riot_directory, args.result_directory, boards)
